document.addEventListener("DOMContentLoaded", function () {
  ...
  const dialogData = [
    { name: "チームExp.", text: "まず、Robertさんの自己紹介をお願いします。", title: "自己紹介"},
    { name: "Robertさん", text: "92年生まれ、名前はRobert、以上です。"},
    { name: "チームExp.", text: "幼いことから様々な海外の経験がある方だとお聞きしておりますが、その中で、アメリカに行こうとした理由があれば聞きたいです。", title: "大学をアメリカの大学に行こうとした理由"},
    { name: "Robertさん", text: "アメリカは外国からの人材の受け入れに非常に寛容な国です。アメリカは移民の国であり、特定のアイデンティティを持たない国です。ナチスが敗北した後、ナチスの才能が持ち込まれたことを見ても、アメリカがいかに優れているかが分かります。つまり、アメリカほど実力主義で成果主義の社会はありません。自分自身と自分の能力に信頼を持てる社会は他にないのです。自信があればアメリカに行かない理由はないと考えました。アメリカは最もシンプルな形で自分の潜在能力を発揮できる場所です。" },
    ...
    { name: "チームExp.", text: "最初に海外にでなければって思った理由がありますか？", title: "なぜ、海外に行こうとしたのか" },
    ...
    { name: "チームExp.", text: "元の名前ではなく、自分で決めた名前を使う理由がありますか？", title: "自分で決めた名前" },
    { name: "Robertさん", text: "私は自分自身の名前で独立して生きようとしています。親から与えられた名前ではなく、「私」として生きるために、自分で選んだ名前を使っています。" },
    { name: "チームExp.", text: "海外就職についてどのように考えているのか聞いてみたいです。", title: "海外就職についてのお考え" },
    ...
    { name: "チームExp.", text: "私たちのテーマそのままの質問になりますが、新しい環境によく適応して活躍するためにはどうすればよいでしょうか", title: "新しい環境に適応し、活躍する方法" },
    ...
    { name: "チームExp.", text: "韓国と海外の文化の違いや、韓国とアメリカの文化の違いを聞いてみたいです。", title: "韓国と海外の文化の違い" },
    ...
    { name: "チームExp.", text: "個性を放棄させる社会とのことでしたが、個性がある人になるためにはどうすればよいでしょうか", title: "個性がある人になるためには" },
    ...
    { name: "チームExp.", text: "アメリカやイギリスで差別を受けた経験がありますか？", title: "海外で差別を受けた経験" },
    ...
    { name: "チームExp.", text: "差別に対処する方法についてもう一度聞いてもらえますか", title: "差別に対処する方法" },
    ...
    { name: "チームExp.", text: "差別以外に、外国で住むことで大変だったことがありましたらお聞きしたいです。", title: "海外で大変だったところ" },
    ...
    { name: "チームExp.", text: "Robertさんは人を接するときにどのような態度で接しようと努力するのか聞きたいです。", title: "人をどのように接しようとしているのか" },
    ...
    { name: "チームExp.", text: "英語はもちろん、日本語、中国語もできる方だと聞いたのですが、学ぶときに難しかったところがあったら聞いてみたいです。", title: "色々な言語を学ぶことで大変だったところ" },
    ...
    { name: "チームExp.", text: "文化を理解するためには言語を学ぶことが最もだとおしゃったのですが、そういうことを感じた経験がありますか？", title: "異文化を理解するには言語を学ぶことが第一" },
    ...
    { name: "チームExp.", text: "自分が本当にやりたい仕事を探す方法は何だと思いますか？", title: "自分がやりたい何かを探す方法" },
    ...
    { name: "チームExp.", text: "インタビューは以上ですが、何か最後に一言お願いします。", title: "最後の一言" },
