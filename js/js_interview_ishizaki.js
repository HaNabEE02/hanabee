document.addEventListener("DOMContentLoaded", function () {
  ...
  const dialogData = [
    { name: "ジョンビョンチャン", text: "まず、石崎さんの自己紹介をお願いします。", title: "自己紹介" },
    { name: "石崎さん", text: "石崎希と申します。今1998年生まれなので、日本だったら今25、6になる年で、韓国だと多分27になるだと思います。大学卒業してから就職、すぐ就職してit系の会社に勤めていて、今もその会社で仕事をしてます。" },
    { name: "ジョンビョンチャン", text: "現在、どのようなプログラミング言語使って仕事をなさっているのか聞きたいです！", title: "どんなプログラミング言語を使って仕事をしているのか" },
    { name: "石崎さん", text: "私が今やってるのは、webサイトでホテルの予約とかができるようなサイトのフロントエンドの開発をしてるんですけど、基本的にはリアクトタイプ、スクリプト、その辺を使ってます。" },
    { name: "ジョンヘスン", text: "今のオープンリソース株式会社に就職したいと決めたきっかけなどがありますか。その会社のどこが好きで、この会社にしなければという気持ちを持ったのか、それも少し聞いてみたいと思います。", title: "今の会社にした理由" },
    ...
    { name: "石崎さん", text: "今、そのオープンリソースって会社が、私が勤めてるit系の会社なんですけど、もう1個、グッドデイズかなっていう、も1個、不動産の会社をやってるとことグループの会社になってまして。そのグッドデイズっていう方をサービスとして、その不動産サービスをやってるのを知っていたので、ちょっと話聞きに行ってみようってことで、面接に行きました。" },
    ...
    { name: "ジョンヘスン", text: "今、会社でit業界で働いているんですけれど、元々の専攻は、なんか音楽系、メディア系だったと思うんですけど、何の専攻か、ちょっと教えていただきたいです。", title: "大学での専攻" },
    ...
    { name: "ソンスンジュン", text: "非専攻ながら、it業界に興味を持ったきっかけなどがあったらぜひ聞いてみたいと思います。それとも、itいいなと思い始めたきっかけなどとか…", title: "ITに興味を持ったきっかけ" },
    ...
    { name: "ジョンビョンチャン", text: "日本it業界に就職する、今、働いているその会社に就職する前には相手の勉強をしたことが全然なかったという話を聞いたんですけれども、内定をもらってからitの勉強をされたとかが、ありますか。", title: "内定の前後に関連の教育を受けたことがあるのか" },
    ...
    { name: "ソンスンジュン", text: "新入社員研修の中で、具体的に何を学ぶのかも少し聞きたいと思います。", title: "新入社員研修で何を学んだのか" },
    ...
    { name: "ジョンビョンチャン", text: "就職して会社に入った直後に、厳しかったこととか、本当に辛いなという経験が特にあったら少し話し聞いてみたいと思います。", title: "会社に入って大変だったところ" },
    ...
    { name: "ジャンドンヒョク", text: "最初にit業界に興味を持って就職生活をしてからは就職して、その前まで持っていたit業界への印象と印象と今持っているit業界への印象が変わったとか、最初はこんな印象だったのに今はこんな認証ですよという説明少しもらえますか。今なさっている仕事の中でも、全然大丈夫です。", title: "自分が持っていたIT業界への印象と実際の違い" },
    ...
    { name: "ソンスンジュン", text: "it業界で私たちが聞くには、割とコミュニケーション能力が大事ということなんですけれど、それは本当になんかコミュニケーション能力が一番大事という会社もあって、それがどうなのか少し聞きたいです。", title: "IT業界でコミュニケーション能力が大事なのか" },
    ...
    { name: "ジョンヘスン", text: "it業界で残業とか、仕事の両が多いとご存じなんですけれど、そういうストレスちょっと溜まると思います。そういうストレスの発散とかはどうしたら大丈夫か今どうしてるのかがお聞きしたいと思ってます。", title: "ストレス解消の方法" },
    ...
    { name: "ジョンビョンチャン", text: "非専攻者として協力に入って、専攻者の同期がいると言いましたが、そのような人とどんな差があったと感じましたか？そのような差を乗り越えるためにどのような努力をしましたか？", title: "専攻と非専攻で差を感じた瞬間と対処" },
    ...
    { name: "ジョンヘスン", text: "韓国に6ヶ月間留学に来ましたが、留学したきっかけとどのように行ったのか教えて下さい。", title: "韓国留学のきっかけ" },
    ...
    { name: "ジョンヘスン", text: "韓国にいる時に大変だったことが特になかったんですか？", title: "韓国留学の時、不安に思ったこと" },
    { name: "石崎さん", text: "最初の2日3日ぐらいは若干自分が知ってる人が誰もいない状態だったので、ここでうまくやっていけるかなっていう不安はありました。" },
    { name: "ジョンヘスン", text: "そのような不安はどう解決したのでしょうか？", title: "留学で自分なりに克服した方法	" },
    ...
    { name: "ソンスンジュン", text: "最後に何か一言したいことがあったらお願いします。", title: "最後の一言" },
  ...
  function startTyping() {
    if (!isTyping) {
      ...
      if (currentDialog.title) {
        dialogTitle.textContent = currentDialog.title;
      }
    ...
    if (!event.target.closest(".menu-ico")) {
      if (isTyping) {
        ...
        if (currentTextIndex < dialogData.length) {
          ...
          dialogText.textContent = "インタビューが終了致しました。５秒後にメイン画面に戻ります。";
        }
      }
