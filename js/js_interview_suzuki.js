document.addEventListener("DOMContentLoaded", function () {
  ...
  const dialogData = [
    { name: "チームExp.", text: "まず、鈴木和夫様の自己紹介をお願いします。", title: "自己紹介" },
    ...
    { name: "チームExp.", text: "今、韓国で仕事をしてると思うんですけれど、今の会社に入ったきっかけとかあったら教えてください。", title: "今の会社にした理由" },
    ...
    { name: "チームExp.", text: "自分が専攻した科目ではなくても、他の色々なところに就職することが多かったという理由でしたんですけど、なぜ石油化学の会社を選んだのか理由がありますか？", title: "なぜ、石油化学の会社を選んだのか" },
    ...
    { name: "チームExp.", text: "新しい環境でどうやったら適応してうまく生きることができるのかっていうテーマがあるんですけど、それに関してはなんか考えていただけますか。", title: "新しい環境に適応する方法" },
    ...
    { name: "チームExp.", text: "はい。では、アメリカに派遣してから英語の勉強を始まりましたか。", title: "海外で働く前にしておけばいい勉強" },
    ...
    { name: "チームExp.", text: "アメリカ人がなんか仕事をする時に、方法とかが違くなるということですかね", title: "海外で働くことは？"},
    ...
    { name: "チームExp.", text: "行く場所の文化とか歴史とかを話したんですけれど、そのためになんか勉強を事前にやって、その国に行く方がいいということでしょうか。",  title: "文化や歴史を勉強しなければならない理由？" },
    ...
    { name: "チームExp.", text: "いろんな海外で働いた経験があると聞きましたけど、そこで、なんか海外で働いている状況に関しては、海外の就職に関しては、どのような考えを持っているのかがしたいと、お聞きしたいと思います。",  title: "海外就職に関してのお考え" },
    ...
    { name: "チームExp.", text: "海外経験の中で特に面白かった国があれば、聞いてみたいです。", title: "海外生活の中で面白かったエピソード" },
    ...
    { name: "チームExp.", text: "なんか外国人の立場として海外で生きる中、嫌いなこととか、なんか辛い思いもあるんじゃないかなって思うんですが…", title: "海外生活で大変だったこと" },
    ...
    { name: "チームExp.", text: "もし私たちが日本で差別を受ける状況になると、どう対処するのがいいと思っているのかも少し聞きたいと思いますが。はい。ちょっと私たちより年寄りの方の意見を聞いてみたいです。", title: "海外生活で差別を受けた時に、対処方法" },
    ...
    { name: "チームExp.", text: "海外で一応長く働いていたと思うんですけど、日本の中で働きたいっていう気持ちはなかったんでしょうか。", title: "日本で働いたいと思ったことは？" },
    ...
    { name: "チームExp.", text: "自分が思っているキャリアプランが、なんか思い通りにできなかった場合の克服方法とかありますかね。", title: "自分が思ったキャリアプラン通りにできなかったら" },
    ...
    { name: "チームExp.", text: "最初に、その化学は、石油化学の勉強をされる時に、元々自分が勉強してきた専攻と違う、専攻っていうか、違う、事業を学ぶことにおいて大変だったところとかございましたらお願いします。", title: "専攻と違う仕事を学ぶ時に大変だったこと" },
    ...
    { name: "チームExp.", text: "少し話をずれて、企業経営者の立場として、新入社員に対して話してみたいこととかあれば教えていただけますでしょうか。", title: "経営者として、新入社員に期待すること" },
    ...
    { name: "チームExp.", text: "海外企業で働いた期間が長いとおしゃったんですが、その中に社員と考えとその自身の考えが違うことがあったことがあると思います。それをどうやって解決するのか。", title: "海外で外国の方と働く時に働き方の認識の違い" },
    ...
    { name: "チームExp.", text: "企業を経営してる立場として、1番大事な、心がけとか、こういうのをしなければならないとかがあったら、ちょっと教えていただけますか。", title: "企業を経営する立場で大事な心がけ" },
    ...
    if (!event.target.closest(".menu-ico")) {
      if (isTyping) {
        ...
        if (currentTextIndex < dialogData.length) {
          ...
          dialogText.textContent = "インタビューが終了致しました。5秒後にメイン画面に戻ります。";
        }
      }
      if (currentTextIndex == dialogData.length) {
        setTimeout(() => {
